...
- `apm init --discover [--apply]` imports supported existing configuration into a managed package for onboarding and target-specific rendering, with protected refreshes, bounded credential screening, explicit unsupported-conversion reports, and a `docs/src/content/docs/specs/openapm-v0.1.md` optional-import contract -- by @chkp-roniz (#2857)
